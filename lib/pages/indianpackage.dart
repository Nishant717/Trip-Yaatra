...
class IndianPackages extends StatefulWidget {
  const IndianPackages({super.key});

  @override
  State<IndianPackages> createState() => _IndianPackagesState();
}

class _IndianPackagesState extends State<IndianPackages> {
  @override
                  ...
                  child: Row(
                    children: [
                      ...
                      const Text(
                        "Destination",
                        style: TextStyle(
                          color: Color.fromARGB(255, 84, 138, 183),
                          fontSize: 30.0,
                          fontWeight: FontWeight.bold,
                        ),
                      ),
